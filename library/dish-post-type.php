...
function dish_post() { 
	...
	register_post_type( 'dish', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Dish Types', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Dish Post', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Dish Posts', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Dish', 'bonestheme' ), /* Add New Display Title */
			...
			'description' => __( 'A dish for restaurant', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	register_taxonomy_for_object_type( 'category', 'dish' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'dish' );
	
}

	// adding the function to the Wordpress init
	add_action( 'init', 'dish_post');
	...
	*/
	...
	register_taxonomy( 'custom_cat', 
		array('dish_post'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				'name' => __( 'Dish Categories', 'bonestheme' ), /* name of the custom taxonomy */
